  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-background">
        <div className="absolute top-10 left-20 w-32 h-32 bg-primary/5 rounded-[60%_40%_70%_30%] animate-float" />
        <div className="absolute top-32 right-16 w-24 h-24 bg-accent/10 rounded-[40%_60%_30%_70%] animate-float" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-20 left-1/3 w-20 h-20 bg-coral/8 rounded-[70%_30%_40%_60%] animate-float" style={{ animationDelay: '4s' }} />
      </div>
